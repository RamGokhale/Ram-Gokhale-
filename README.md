...
|---------|-------------|------------|
| 🎓 **Students Corner** | Learning platform with GK, mock tests & job listings | React, Node.js, MySQL |
| 📄 **EasyDocument** | PDF merge, split, compress & convert tools | React, Express.js |
| 🏠 **Property Rental** | Airbnb-style app with chat & payments | React, MongoDB, JWT |

---

## 🌱 Currently Learning

![System Design](https://img.shields.io/badge/System_Design-A855F7?style=flat-square&logoColor=white)
